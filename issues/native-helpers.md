...
| --- | --- | --- | --- |
| FT035 | Rejected | `linear_layout.cc` | [Shared MLIRContext, linear_layout (rejected)](native-helpers/shared-mlir-context.md) |
| FT034 | Rejected | `linear_layout.cc` | [`__imul__` mutates a shared `LinearLayout` Python object in place (rejected)](native-helpers/imul-shared-mutation.md) |
| FT031 | Rejected | `linear_layout.cc` | [`get_shared_view` / `get_distributed_view` use `const_cast`; const-correctness only](native-helpers/const-cast-views.md) |
| FT032 | Rejected | `gluon_ir.cc` | [Shared MLIRContext, gluon_ir (rejected)](native-helpers/gluon-builder-context.md) |
