...
|---|----------|-----------|------|-------|
| 1 | MED | code_generator | 3 | [`gscope` iteration race in `CodeGenerator.__init__` and `call_JitFunction`](#1-gscope-iteration-race-already-filed) — already filed in `compiler/`; re-listed here for component completeness |
