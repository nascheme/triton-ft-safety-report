...
|---|----------|-----------|------|-------|
| 1 | Significant | DriverConfig.default | 1 | [`DriverConfig.default` lazy init race creates duplicate driver instances](runtime-driver/driver-default-lazy-init-race.md) |
| 2 | Significant | DriverConfig.active  | 3 | [`DriverConfig.active` lazy init / `set_active` ordering race](runtime-driver/driver-active-set-active-race.md) |
| 3 | Significant | hot-path callers     | 3 | [Hot-path callers re-read `driver.active` across multiple statements](runtime-driver/driver-active-caller-reread.md) |
| 4 | SEVERE      | upstream import      | 1 | [Upstream segfault on Python 3.13t during Triton import](runtime-driver/seg-fault-gh-6721.md) |
